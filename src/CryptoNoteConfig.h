// Copyright (c) 2017-2018 The Bitstone developers
...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x4bcf;
...
const uint64_t MONEY_SUPPLY                                  = ((uint64_t)(2700000000000));
...
const char     CRYPTONOTE_NAME[]                             = "BitStone";
